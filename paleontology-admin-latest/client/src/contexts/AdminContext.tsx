...
const ROUTE_PERMISSIONS: Record<string, AdminRole[]> = {
  ...
  "/admin/audit-trail": ["super_admin", "branch_admin"],
  "/admin/recognition": ["super_admin", "branch_admin"],
...
const ALL_MENU_ITEMS: MenuItem[] = [
  ...
  { path: "/admin/recognition", label: "识别结果", icon: "ScanSearch" },
  { path: "/admin/audit-trail", label: "审计追溯", icon: "History" },
  { path: "/admin/branches", label: "学会/分会管理", icon: "Building2" },
  { path: "/admin/scope", label: "数据权限", icon: "Shield" },
  {
    path: "/admin/cms",
    label: "内容管理",
    icon: "FileText",
