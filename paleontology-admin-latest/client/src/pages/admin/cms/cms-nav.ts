...
export const CMS_SECTION_META: Record<string, CmsSectionMeta> = {
  ...
  pages: { title: "学会简介", subtitle: "维护学会概况、章程、发展规划及领导机构、获奖成果（与前台子栏目同步）" },
  personnel: { title: "组织机构", subtitle: "维护总学会组织机构图与管理系列（与前台 /structure 同步）；人员请在「学会简介 → 领导机构」维护" },
  ...
  services: { title: "学会服务", subtitle: "会员/会议服务及科学传播、国际交流、科技奖励（与顶栏 /international、/science 共用数据源）" },
  international: { title: "国际交流", subtitle: "已合并至学会服务，请在此维护" },
  science: { title: "科学传播", subtitle: "已合并至学会服务，请在此维护" },
  "tech-rewards": { title: "科技奖励", subtitle: "已合并至学会服务，请在此维护" },
  regulations: { title: "规章条例", subtitle: "编辑规章条例正文与附件" },
  party: { title: "党建文化", subtitle: "维护党建各子栏目的文章与专题" },
  branch: { title: "分会栏目", subtitle: "维护分会子站各栏目：概况、工作动态、科学传播、下载中心等（与前台 /structure/branch 同步）" },
  ...
  "public-files": { title: "公开文件管理", subtitle: "统一管理公开文件与学会资料下载（文档/音频/影视/照片），无需登录即可下载" },
};
