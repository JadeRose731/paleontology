...
export type BranchSectionId = (typeof BRANCH_SECTION_IDS)[number];
...
export type StructurePanelId = (typeof STRUCTURE_PANELS)[number]["id"];
...
/** 旧 /branches 卡片 ID → canonical 分会 ID */
